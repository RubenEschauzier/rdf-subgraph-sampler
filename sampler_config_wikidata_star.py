...
DEFAULT_GRAPH_URI = "http://localhost:8890/wikidata"
SHAPE = "star"  # Shape of subgraphs to generate: "path", "star", "flower", "snowflake"
DATASET = "wikidata"  # Dataset name (used for output file)
...
RDF_FILE_PATH = "data/wikidata.ttl"  # Path to RDF file to use
